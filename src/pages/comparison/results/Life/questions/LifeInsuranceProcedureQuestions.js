...
const LifeInsuranceProcedureQuestions = () => {
  ...
  const steps = [
    ...
    <BeneficiaryInformationForm onSubmit={handleSubmit} professions={professionList} isLoading={isLoading} formData={formData} setFormData={setFormData} onBack={() => handleNextStep(0)} />,
  ];
